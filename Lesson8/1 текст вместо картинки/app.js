...
function handleClick(clickedButtonEvent) {
    ...
    const textButton = cardNode.querySelector('button').innerText
...
function showMoreText(card) {
    ...
    const otherText = 'other Text other Text'
    // 6.2 внутри .product есть .productName, после него вставляем div.desc и текстом из переменной из п. 6.1
    card.productName.insertAdjacentHTML('afterend', `<div class="desc">${otherText}</div>`);
